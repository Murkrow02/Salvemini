...
namespace SalveminiApi_core.Pages.Shared
{
    public class DashboardModel : PageModel
    {
        private readonly Salvemini_DBContext db; private readonly IConfiguration configuration;
        public DashboardModel(Salvemini_DBContext context, IConfiguration conf) { db = context; configuration = conf; }
        ...
        public async Task<IActionResult> OnGet()
        {
          ...
          var userBooks = db.BookLibri.Where(x => x.IdUtente == user.Id);
            ...
            {
                if(book.Prezzo != null && book.CompratoDa != null)
