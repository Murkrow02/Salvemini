...
{
    public class SingleGameLayer : CCLayerColor
    {
        ...
        public SingleGameLayer() : base(new CCColor4B(204, 255, 255)) //This color is to match the sky background we will use for the parallax scrolling effect
        {
        ...
        protected override void AddedToScene()
        {
            ...
            scoreLabel.Position = new CCPoint(VisibleBoundsWorldspace.MaxX / 2, VisibleBoundsWorldspace.MaxY - scoreLabel.ContentSize.Height * 2);
        ...
        private void GameLoop(float currentTime)
        {
            ...
            //Jump
            CCVector2 jumpForce = new CCVector2(0, 610);
            if (isTapping)
            {
        ...
        void CreatePipesAndCoins()
        {
            ...
            var bottomPipe = new CCSprite("bottom_pipe");
            ...
            var topPipe = new CCSprite("top_pipe");
