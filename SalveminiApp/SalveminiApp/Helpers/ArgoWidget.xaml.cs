...
namespace SalveminiApp
{
    public partial class ArgoWidget : ContentView
    {
        ...
        public ArgoWidget()
        {
            ...
            //Set dimensions
            image.WidthRequest = App.ScreenWidth / 3.5;
            image.HeightRequest = App.ScreenWidth / 3.5;
            view.WidthRequest = App.ScreenWidth / 3;
            view.HeightRequest = App.ScreenWidth / 3;
            mainLayout.WidthRequest = App.ScreenWidth / 3;
            mainLayout.HeightRequest = App.ScreenWidth / 3;
