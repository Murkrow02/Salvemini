...
namespace SalveminiApp.SecondaryViews
{
    public partial class Team : ContentPage
    {
        public Team()
        {
            ...
            layout.Children.Add(new Controls.TeamPersonFrame { Icon = "instaLogo",Image = Costants.Uri("images/users/2106"), Title = "Marco Coppola", SubTitle="Backend e Frontend Developer", IconUrl= "https://www.instagram.com/_murkrow_/"});
