...
namespace BigTed2
{
	public class ProgressHUD2 : UIView
	{
		...
		public ProgressHUD2 () : this (UIScreen.MainScreen.Bounds)
		{
		}

		public ProgressHUD2 (CGRect frame) : base (frame)
		{
		...
		public UIFont HudFont = UIFont.SystemFontOfSize (16f);
		...
		static ProgressHUD2 sharedHUD = null;

		public static ProgressHUD2 Shared {
			get {
				if (sharedHUD == null) {
					UIApplication.EnsureUIThread ();
					sharedHUD = new ProgressHUD2 (UIScreen.MainScreen.Bounds);
				}
				return sharedHUD;
			}
		}
		...
		bool isClear {
			get {
				return (_maskType == ProgressHUD2.MaskType.Clear || _maskType == ProgressHUD2.MaskType.None);
			}
		}
		...
		bool forceiOS6LookAndFeel = true;
